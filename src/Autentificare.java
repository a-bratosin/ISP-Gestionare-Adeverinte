...
class Autentificare {
    ...
    public static Utilizator login(String email, String parola) {
        ...
        String[] dateDeBaza = csvManager.findRow("utilizatori.csv", "email", email);
        ...
        if (rol.equals("Student")) {
            ...
            return new Student(userId, nume, prenume, telefon, email, parola, nrMatriceal, serie, grupa);
            ...
            return new SecretarDeAn(userId, nume, prenume, telefon, email, parola, an, programDeLucru, programPublic);
            ...
            return new Decan(userId, nume, prenume, telefon, email, parola, semnatura, facultate, idMandat);
        }
        return null;
